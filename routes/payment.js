...
// ---------------------------
// 💰 Thuật toán tự động tính giá theo gói (MỚI THÊM)
// ---------------------------
const getPackagePrice = (packageType) => {
  switch (packageType) {
    ...
    case "threeToSevenDays":
      return 40000; // 100.000 VND
    case "monthly":
      return 60000; // 300.000 VND
    default:
...
router.post("/create", authenticate, async (req, res) => {
  try {
    let { amount, packageType, orderCode } = req.body;
    ...
    // 🧠 Nếu frontend không truyền amount → tự lấy giá từ thuật toán
    if (!amount || amount <= 0) {
